...
def main():
    ...
    # --- MODIFICATION START (FIXED FileNotFoundError) ---
    # Check if the provided path is a directory. If it's a file, get its containing directory.
    ...
    # Use the corrected path to build file paths
    ...
    for round_name in ["round1", "round2", "round3"]:
        ...
        # This part should now work correctly as scored_file has a valid path
        # Ensure the directory for scored_file exists, just in case.
